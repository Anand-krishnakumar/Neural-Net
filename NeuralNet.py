...
class NeuralNet:
    ...
    def train(self, activation, max_iterations, learning_rate):
        ...
        print("After " + str(max_iterations) + " iterations, the total error is " + str(np.sum(error)) + ". Activation function = " + str(activation))
...
if __name__ == "__main__":
    ...
    neural_network.train(activation = "sigmoid", max_iterations = 200, learning_rate = 0.05)
    neural_network.predict(activation = "sigmoid" )

    # tanh activation function 
    # neural_network.train(activation = "tanh", max_iterations = 200, learning_rate = 0.001)
    # neural_network.predict(activation = "tanh" )

    # relu activation function
    # neural_network.train(activation = "relu", max_iterations = 1000, learning_rate = 0.009)
    # neural_network.predict(activation = "relu" )
